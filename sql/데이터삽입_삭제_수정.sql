...
VALUES (13, 'PARK', 35, 'ULSAN');

SELECT * FROM test_member;
-- 데이터 수정 UPDATE
-- UPDATE 테이블명 SET 컬럼명 = 값 [WHERE 조건];
-- WHERE 조건절을 작성하지 않으면 모든 데이터가 변경 된다.
UPDATE test_member
SET 
MEM_NAME = '이순신';
