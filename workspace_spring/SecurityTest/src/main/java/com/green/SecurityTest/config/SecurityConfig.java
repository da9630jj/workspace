...
public class SecurityConfig {
    ...
    */
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        //react 를 제외한 나머지 전통적인 프론트 단(thymeleaf, jsp)을 만드는 기술을 사용할 떄는
        // form 방식의 로그인 채택
        ...
        httpSecurity.addFilterAt(new LoginFilter(getAuthenticationManger(configuration)), UsernamePasswordAuthenticationFilter.class);
